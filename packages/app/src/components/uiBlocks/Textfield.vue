<template>
  <div class="max-w-max flex flex-col">
    ...
    <!-- textfield with icon-->
    <div
      class="flex flex-row border-2 bg-white bg-opacity-80 border-yellow-400 px-4 py-1 rounded-full focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-25 shadow-lg"
    >
