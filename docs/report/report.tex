...
Da die meisten am Markt erhältlichen Smarte Spielzeuge jedoch relativ teuer sind,
sollte mit diesem Projekt  eine Open-Source-Alternative geschaffen werden.
...
Im weiteren Gespräch mit den Kunden ergaben sich weitere ergänzende Anforderungen an das Produkt:
\begin{center}
  \begin{tabular}[h]{c|c}
    Anforderung & Klassifikation \\
    \hline
...
So wurde sich zum Beispiel gegen bezahlte Services \colorbox{red}{für subdomains (bessere formulierung?)} entschieden, was die Usability etwas einschränkte, jedoch mehr dem Open-Source-Gedanken des Projektes entspricht.
