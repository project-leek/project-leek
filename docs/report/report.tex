...
\paragraph*{Vue.js} $~$ \\
\colorbox{orange}{components und reactivity sollten noch beschrieben werden!}
...
Zu Beginn wurden die letzten Softwaretickets abgeschlossen. Vor allem im User Interface wurden noch letzte Änderungen durchgeführt.
...
\begin{wrapfigure}{r}{0cm}
  \includegraphics[width=0.45\textwidth]{noTagsFound.png}
  \caption{no tags found div}
\end{wrapfigure}
\\
