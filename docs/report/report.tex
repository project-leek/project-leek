...
Durch die vielen automatisch generierten Dateien und Ordner wirkte die Komplexität und somit Einstiegshürde groß, und Teammitglieder brauchten Ihre Zeit, um effektiv mitarbeiten zu können.
Über die Entwicklungszeit wurden aber die neuen Technologien vertieft und verinnerlicht.
Das Team lernte auch wieso Frameworks und Librarys wie Vue, Tailwind und Feathers sinvoll und hilfreich sein können.

\subsubsection{Versionskontrolle und Deployment Cycle}
Im Studium wurde den Studierenden der Vorteil von Versionskontrollsystemen wie Git vermittelt, doch fand sich im Studium selten ein praktisches Anwendungszenario, dass Git über die Hauptfunktion der Versionierung hinaus sinnvoll genutzt hat.
Durch dieses Projekt fand sich das erste mal im Studium eine sinnvolle Anwendung, wie in größeren Projekten oder in der Industrie auch mit Pull Requests und Code Reviews zu arbeiten.
Dadurch traten mehrere Effekte auf:
Wenn mehrere Teammitglieder über den Code anderer schauten, fielen umso wahrscheinlicher Fehler auf und eine insgesamt bessere Codequalität wurde sichergestellt.
Code Reviews hatten außerdem den Effekt, dass Teammitglieder neue Funktionen und Änderungen kennenlernen, verstehen und gegebenenfalls auch direkt Fragen dazu stellen konnten.
...
Durch diese Tests wurden sowohl dem Team viel manuelle Arbeit abgenommen, als auch wurde die Fehlerquelle Mensch minimiert.
...
Dadurch konnte sich das Team mehr auf das Weiterentwickeln des Projektes konzentrieren.

\subsubsection{Regelmäßige Standups und Retrospektiven}
Durch die regelmäßigen Standups entstand ein Ort für das gegenseitige ansprechen von Problemen, updaten von Fortschritten und neuen Funktionen.
So gingen seltener Probleme unter, neues Wissen wurde schneller verbreitet und die gesamte Teamproduktivität wurde verbessert.
Das bei den Retrospektiven entstandene Feedback zwischen dem Teammitgliedern war sehr wichtig für das Teamklima.
...
Die Standups hatten auch den Effekt, dass das Team anfangs sich zu sehr auf diesen Kommunikationsweg verlassen hat, wodurch Probleme und wichtige Kommunikation bei Abhängigkeit zwischen Tickets zu selten statt fand.
Hier fehlte anfangs die Eigeninitiative, bei Problemen aktiv sich Hilfe zu holen, auch weil manche Tickets zu schwierig wirkten, um diese alleine zu bewältigen.
Hierbei halfen einerseits die Retrospektiven, die dieses Problem ansprachen, aber vor allem die teaminterne Evaluation.

\subsubsection{Planung, Zielsetzung und Einschätzung}
Das größte Problem während des Projektes war, dass gegen Ende eines Sprints geplante Tickets nur teilweise fertiggestellt wurden.
Häufig konnten nicht alle Tickets genügend auf Fehler getestet werden und wurden entweder in den nächsten Sprint gelegt oder mit kleineren Bugs in den Master Branch gemerged.
...
So hat das Team sich auch vorgenommen, mindestens zwei Tage vor einem Sprintende fertig zu sein.
...
Dieses Problem hätten auch effizienter behandelt werden können, allerdings war dies die effektivste Möglichkeit für den gegeben knappen zeitlichen Projektrahmen.
