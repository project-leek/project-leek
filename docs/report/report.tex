...
Da die aktuell am Markt erhältlichen Konkurenzprodukte wenig konfigurierbarkeit bieten, zum Beispiel kein anderer Lautsprecher ausgewählt werden kann, sollte hier eine Open-Source Alternative geschaffen werden, die dem Nutzer volle Freiheiten zur Anpassung bietet.
...
\\
\colorbox{orange}{Hier bei Bedarf noch weiter ausführen (aber wäre sehr ins Detail gegeangen)}
...
Somit war das Ziel die Umsetzung einer Oberfläche für die Einstellungen der \textit{Leek Box}, als auch der Tags.
...
Zur Verbesserung der Usability wurde dem Nutzer besser signalisiert, ob ein Tag ausgewählt wurde.
