...
Die Meilensteine wurden daher ausführlicher behandelt, beinhalteten nun auch genauere Programmierumsetzungen.
Außerdem hatte sich das Team mit der finalen Projektpräsentation befasst.
Mit dieser sollte dem Prüfenden sowie dem Projektbegleitenden Unternehmen macio, welches auch gleichzeitig der Kunde darstellt, die verschiedenen Entscheidungen und Iterationen des Projektes präsentiert werden.
Auch sollte das finale Produkt und deren Funktionsweise dem Kunden erklärt werden, sodass dieser das Produkt selbstständig nutzen und weiterentwickeln kann.
