...
Über die Entwicklungszeit wurden aber sinnvolle neue Technologien vertieft und verinnerlicht.
Webentwicklung größerer komplexerer Webseiten ohne Frontend Frameworks wie Vue sind heutzutage oftmals kaum noch sinnvoll\cite{stackoverflow:why_Frameworks}.
...
Durch das Automatisierte Deployment wurden bei neuen Änderungen im Master die Seite auf Github.io veröffentlicht, als auch wurden die \textit{LaTeX} Dateien als PDF im eigenen Dokumente Branch gebaut.
...
\subsubsection{Zu viel Automatisierung?}
\colorbox{red}{Todo:} DevOps hat uns viel geholfen, PR Checks sind praktisch, aber vielleicht zu sehr ins Detail gegangen?
...
\colorbox{red}{Todo:} Man hätte mehr miteinander kommunizieren können, Abhängigkeit zwischen Komponenten nicht für selbstverständlich halten sondern kommunizieren. Aktiver auf Gruppe zugehen und ansprechen, helfe holen, gemeinsam lösen
