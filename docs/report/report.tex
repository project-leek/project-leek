...
\paragraph*{Bericht}
Da die erste Version des Berichtes zu Beginn des Sprints noch nicht fertig war, musste das Team dies zeitig erledigen, um noch erste Anmerkungen vom Prüfenden erhalten und korrigieren zu können.
Nach erneuter Rücksprache ergab sich die Anforderung für den Bericht von 50-60 Seiten (ohne Anhang).
Mit dem bisherigen Entwurf und noch geplanten Abschnitten wäre es dem Team sehr schwer gefallen, diese Anforderung umzusetzen.
Daher traf sich zu Beginn das Team, um den Bericht gemeinsam durchzugehen und ggf. zu ändern.
Dabei ergaben sich verschiedene Änderungen:\\
Die Meilensteine wurden ausführlicher behandelt und es wurde mehr auf die Durchführung und Herangehensweise eingegangen.
Wichtiger und zentraler Quellcode wurde hier hinzugefügt, behandelt und erklärt.
Auch fehlten an vielen Stellen Bilder und Beispiele, die die jeweiligen Probleme, Lösungen und Ansätze besser veranschaulichen.
Zusätzlich zu dem Bericht befasste sich das Team mit der finalen Projektpräsentation.
In dieser sollte dem Prüfenden sowie dem Projektbegleitenden Unternehmen macio, welches auch gleichzeitig den Kunden darstellt, die verschiedenen Entscheidungen und Iterationen des Projektes präsentiert werden.
Auch sollte das finale Produkt und deren Funktionsweise dem Kunden erklärt werden.
Am Ende dieser Präsentation sollte der Prüfende die Arbeitsleistung des Teams evaluieren können und der Kunde das Produkt selbstständig nutzen und weiterentwickeln können.
