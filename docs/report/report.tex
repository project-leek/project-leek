...
Diese Richtung des Projektmanagements zeichnet sich vor allem durch kontinuierliches Feedback, kooperatives Arbeiten und Reaktionsfähigkeit bei Anforderungsänderungen aus.
Dementsprechend wurde zu Beginn des Projekt keine feste Planung des Projektverlaufs aufgestellt.
...
Im diesem wählte das Team welche technischen Änderungen während des Sprints am Produkt vorgenommen werden sollten.
Entschieden wurde anhand dem geschätzten Arbeitsaufwand und der verfügbaren Arbeitszeit der Teammitglieder getroffen.
Die geplanten Änderungen überschnitten sich allerdings sehr häufig mit den Kundenwünschen, da diese meist sehr realistisch waren.
...
Aufgrunddessen wurde die Entscheidung getroffen, das Projekt öffentlich auf github aufzusetzten.
