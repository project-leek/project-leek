...
wurde. Sie behinhaltete Attribute wie \glqq Name \grqq{} oder \glqq Id \grqq. Auf dieser Basis wurde anschließend ein Feathers-Service in Form einer
...
die zuvor erstellte Modell-Klasse angegeben. Um z. B. Objekte der Klasse \textit{NicksPet} zu verwlaten wurde folgender Service angelegt:
\begin{lstlisting}
...
Aufgrund der je nach Entwickler sehr unterschiedlichen Implmentierung der \textit{component} wird hier auf eine ausführliche Beschreibung verzichtet.
