...
\subsection{Ausblick}
Am Ende der Bearbeitungszeit steht nun ein Produkt, welches die Mindestanforderungen erfüllt.
Dennoch bleiben noch viele der anfänglichen Wünsche und Vorstellungen offen.
...
Auch die Benutzeroberfläche für die NFC-Tag-Konfiguration sollte noch weiter überarbeitet werden.
Aber vor allem sollten andere Musikstreaming-Services neben Spotify eingebunden werden.
Diese könnten dann in gleicher Weise zur Anmeldung und zum Hinzufügen und Abspielen von Musik genutzt werden.
Nutzer könnten auch ihre Konten bei diesen Services verknüpfen und so NFC-Tags plattformübergreifend gemeinsam verwalten.
All diese Dinge hätte das Team gerne umgesetzt, dies war aber mit dem sehr knappen Zeitrahmen nicht umsetzbar.
...
Des weiteren besteht auch die Hoffnung, dass macio viel aus diesem Projekt gelernt hat und auch fortlaufend weiter daraus lernen wird.
So könnten dort in Zukunft auch weitere Projekte als Open-Source aufgestellt werden.
Des weiteren hofft das Team, dass auch in den nächsten Jahren des \glqq Projekt Informatik \grqq{} mehr Open-Source Projektvorschläge gestellt werden.
