...
werden diese geprüfet und behoben. Sind alle Tests erfolgreich, betätigt der Entwickler die Schaltfläche \textit{Ready for Review}.
Wenn ein anderer Entwickler, diesen \textit{Pull-Request} sieht, wird ein \textit{Code-Review} durchgeführt.
