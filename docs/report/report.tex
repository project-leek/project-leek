...
\graphicspath{ {./images/}{../diagrams/activity_diagrams/}{../mockups/} }
...
\wrapfiguresafe{r}{0mm}{\includegraphics[width=4cm]{PackageStruktur.png}}{Ordnerstruktur\label{fig:Ordnerstruktur}}
...
\includepdf[scale=0.75, pages=-, pagecommand=\section{Projektskizze}\label{pdf:macioprojektskizze}]
...
\section{User-Stories und Use-Flows}
  ...
  \newpage
  \subsection*{Use-Flows, die aus den User-Stories entwickelt wurden}
  \includegraphics[width=0.5\textwidth]{alle nfc tags sehen.png}
  ...
  \includegraphics[width=0.55\textwidth]{einloggen.png}
  \newpage
  \includegraphics[width=0.5\textwidth]{gruppe editieren.png}
  \includegraphics[width=0.5\textwidth]{gruppe erstellen.png}
  \newpage
  \includegraphics[width=\textwidth]{gruppe löschen.png}
  \newpage
  \includegraphics[width=0.45\textwidth]{nfc tag suchen.png}
  \includegraphics[width=0.55\textwidth]{registrieren.png}
  \newpage
  \includegraphics[height=\textheight]{tag editieren.png}
  \newpage
  \includegraphics[height=\textheight]{tag erstellen.png}
  \newpage
  \includegraphics[height=\textheight]{tag löschen.png}


\newpage
\section{Mockups}
  \label{FigmaDesigns}
  \subsection*{Erstes Mockup}
  \includegraphics[width=0.5\textwidth]{v1/Home.png}
  \includegraphics[width=0.5\textwidth]{v1/Carousel.png}
  \newpage
  \subsection*{Zweite und dritte Version des Mockups}
  \includegraphics[width=0.5\textwidth]{v2/Welcome.png}
  \includegraphics[width=0.5\textwidth]{v3/Welcome.png}
  \newpage
  \includegraphics[width=0.5\textwidth]{v2/Login with Spotify.png}
  \includegraphics[width=0.5\textwidth]{v3/Login with Spotify.png}
  \newpage
  \includegraphics[width=0.5\textwidth]{v2/Tag Overview.png}
  \includegraphics[width=0.5\textwidth]{v3/Tag Overview.png}
  \newpage
  \includegraphics[width=0.5\textwidth]{v2/chooseName.png}
  \includegraphics[width=0.5\textwidth]{v3/Choose Name.png}
  \newpage
  \includegraphics[width=0.5\textwidth]{v2/chooseSong.png}
  \includegraphics[width=0.5\textwidth]{v3/Choose Song.png}
  \newpage
  \includegraphics[width=0.5\textwidth]{v2/chooseImage.png}
  \includegraphics[width=0.5\textwidth]{v3/Choose Image.png}
