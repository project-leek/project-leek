...
Die erste Version beinhaltete nur die Startseite  (siehe Abbildung \ref{fig:v1-startseite})und sollte die grundsätzlich benötigten Features aufzeigen.
Als erste Idee kam hier auf, ein Karussell zu nutzen.
Ein Karussell ermöglicht die Ansicht von mehreren Einträgen durch das seitliche scrollen. \colorbox{yellow}{das klingt voll ieh.}
Dadurch konnten die einzelnen Einträge größer gestaltet werden und somit auch mehr Informationen enthalten.
Anfänglich wurden für jeden einzelnen Eintrag auch noch die Tag-ID sowie ein Zahnrad für die Einstellungen angezeigt.

\begin{figure}[h]
  \begin{center}
  \includegraphics[width=\textwidth]{../../mockups/v1/Discover Carousel.png}
  \caption{Mockup v1 - Startseite}
  \label{fig:v1-startseite}
\end{center}
\end{wrapfigure}

\subsection{Version 2}
Das Mockup wurde als nächstes um das anlegen von Tags (siehe Abbildung \ref{fig:v2-tagerstellen}), das Bearbeiten von Tags (siehe Abbildung \ref{fig:v2-tagedit}) und einer Wilkommensseite (siehe Abbildung \ref{fig:v2-welcome}) erweitert.
Die Startseite wurde auch erweitert (siehe Abbildung \ref{fig:v2-welcome}).
Hier wurde schnell gemerkt, dass diese bei mehreren Einträgen schnell unübersichtlich werden kann.
Daher wurde die Möglichkeit für Gruppierungen hinzugefügt, welche auch noch einzelnd aus- und eingeklappt werden können.
Im ausgeklappten Zustand werden die Einträge nicht mehr in einem Karussell angezeigt, sondern nacheinander in einem \colorbox{yellow}{Grid}.

\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.3*\textwidth]{../../mockups/v2/chooseName.png}
    \includegraphics[width=0.3*\textwidth]{../../mockups/v2/chooseSong.png}
    \includegraphics[width=0.3*\textwidth]{../../mockups/v2/chooseImage.png}
  \caption{Mockup v2 - Tag Erstellen}
  \label{fig:v2-tagerstellen}
\end{center}
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{../../mockups/v2/Tag Edit.png}
  \caption{Mockup v2 - Tag Bearbeiten}
  \label{fig:v2-tagedit}
\end{center}
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{../../mockups/v2/Welcome.png}
  \caption{Mockup v2 - Wilkommensseite}
  \label{fig:v2-welcome}
\end{center}
