...
Das Frontend ist vom Raspberry zu Github.io Pages umgezogen.
...
bereitgestellt wird. Daraufhin kann sich der Benutzer über \textit{project-leek.github.io} durch die Eingabe dieser Adresse mit der neuen \textit{Leek-Box} verbinden. Da in der App zu diesem Zeitpunkt noch kein
...
Dieser bestand darin, dass der Container des NFC-Readers versuchte, seine Id in diesem zu setzen, bevor er eine Verbindung zu dem Backend aufgebaut hatte.
Dies konnte gelöst werden, indem ein \textit{Event-Listener}, der die ID in der Datenbank des Backend setzt, auf das \textit{connect}-Event registriert wurde.
...
Zur Behebung dieses Problems wurde eine Offline-Seite konzipiert, die Informationen über den Fehler bereitstellt und die Eingabe einer neuen Adresse ermgölicht.
