...
Haustier im Backend und die Darstellung im Frontend.
\\~\\
...
Möglichkeit NFC-Tags auszulesen implementiert werden. Hierzu wurde im Backend die Klassen und der Service zur Verwaltung eines NFC-Readers und NFC-Tags
analog zu dem in \ref{HelloWorld} beschriebenen Vorgehen angelegt. Außerdem wurde der Microservice \textit{nfc-reader} in der Projektstruktur unter \textit{packages}
angelegt und \colorbox{red}{Hier beschreiben was getan}.

Damit die Entwicklung zeitnah starten konnte, sollten die ersten Mockups für das User Interface erstellt
werden. Mithilfe des Prototyping-Tools \textit{figma} (vgl. \ref*{figma}) wurden Prototypen für den Home-Screen, die .


sowie die Grundstruktur für den Bericht zu dem Projekt angefertigt werden, damit dieser Projektbegleitend aufgebaut werden konnte.
%Probleme
