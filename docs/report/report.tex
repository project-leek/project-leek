...
Innerhalb dieser Zeit sollte die erste Version des Berichtes finalisiert werden, damit das Team noch letzte Anmerkungen vom Prüfenden erhalten konnte, um diese noch vor finaler Abgabe umsetzen zu können.
Nach erneuter Rücksprache mit dem Prüfenden ergab sich eine Anforderung für den Bericht von 50-60 Seiten ohne Anhang.
...
Daher traf sich das Team zu Beginn, um den Bericht gemeinsam durchzugehen und ggf. zu ändern.
Dabei ergaben sich verschiedene Änderungen:\\
Die Meilensteine wurden daher ausführlicher behandelt, es wird mehr auf die Durchführengen und Herangehensweisen eingegangen.
Umgesetzter Quellcode wurde dort hinzugefügt, behandelt und erklärt.
Auch wurden die Abschnitte überarbeitet, da vom Prüfenden diese zu granular waren.
