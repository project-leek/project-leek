...
%Bericht
Anfänglich wurden die Kapitel und Abschnitte für den Bericht überarbeitet.
Basierend auf dem neuen Inhaltsverzeichnis wurden entsprechend Tickets erstellt.
Das hatte den Vorteil, dass im \colorbox{yellow}{Project Board (anderes Wort?)} einfach einzusehen war, welche Abschnitte bereits bearbeitet werden und welche noch offen sind.
