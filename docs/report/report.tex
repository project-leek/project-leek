...
Macio ist die einzige Firma, die ihr Ausschreiben als Open-Source Projekt gestaltete. Sie zeigen damit eine Bereitschaft, die von dem Team geleisteten Arbeitszustunden nicht für sich selbst zu nutzen, sondern einen Beitrag an der Open-Source-Community zu leisten.
Ihr Hauptgeschäft ist das Design und Entwickeln von Mensch-Maschine-Interfaces. Als etabliertes Unternehmen können Sie Jahre Lange Erfahrungen in die Beratungen des Projektes einfließen lassen.
