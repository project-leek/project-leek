...
\section{Tools und Vorgehen}
  ...
  \subsubsection*{Dynamische Tests}
    ...
    Bei diese Testfällen werden User-Stories Schritt für Schritt \glqq durchgespielt\grqq{} und dabei überprüft, ob das Verhalten dem erwartetem entspricht.
    ...
    Für die testenden Entwickler bedeutete das konkret, bei der Überprüfung folgende Schritte zu durchlaufen:
    \begin{enumerate}
