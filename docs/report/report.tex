...
Die dafür benötigten Anwendungen wurden als Microservices konzipiert, um die \colorbox{red}{unabhänige bearbeitung weil open source blub blub}.
Zur Verringerung des Aufwands der Konfiguration und Wartung wurden die einzelnen Microservices in einem Mono-Repository zusammengefasst. Jeder Service
wurde in einem Unterdner des Packages Ordner angelegt (vgl. ). Damit waren die einzelnen Services für jeden Entwickler jederzeit einfach erreichbar, ohne jedes Mal das Repository wechseln zu müssen.
