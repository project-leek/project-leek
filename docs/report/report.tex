...
Zur Veröffentlichung unserer Frontends der \textit{leek-box} verwenden wir den Dienst Github Pages welcher ein Webhosting von statischen Dateien unter einer xyz.github.io URL anbietet.
In unserem Fall, verwenden wird für das Frontend ein separates Repository \textit{project-leek/project-leek.github.io} mit der URL project-leek.github.io.
...
\textit{project-leek/project-leek.github.io} Repository für den GitHub Pages Dienst kopiert. Somit ist findet man unter project-leek.github.io immer die aktuelleste Version der App.
Dies hat den Vorteil, dass Änderungen wie zum Beispiel Bugfixes und neue Features dem Endanwender schnellst möglich zur Verfügung gestellt werden können ohne das zum Beispiel
auf einen Release-Plan Rücksicht genommen werden muss.
