...
Zur Nutzung von NFC Tags, müssen diese gelesen und diese Daten an das Backend übertragen werden können.
...
Docker Integration sollte aufgrund von einfacher Auslieferbarkeit angeboten werden (vgl. \ref{abschnitt:docker}).
