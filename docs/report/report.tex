...
- neu: github flow
- neu: PR + Review
- neu: vue, feathers, tailwind
- schlecht: bei Problemen (nicht weitergekommen) nicht sofort bescheid sagen
- verbessern: mehr den aktuellen stand kommunizieren
...
Mir hat nicht so gut gefallen. Wörtlicher Kundenwunsch wurde viel zu spät in dem sprint behandelt. Auch wenn hello wolrd cool war müssen wir vielleicht in dem nächsten sprint härter priorisieren.
...
Ja da fasse ich mir auch stark selbst an die Nase.
}
...
Neu Gelernt
- stabiles Wissen mit vue (vor alllem reactivity, events und components)
