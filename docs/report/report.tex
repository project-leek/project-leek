...
Zur Verbesserung der Usability wurde dem Nutzer besser signalisiert, ob und welchen Tag dieser angewählt hat.
Dafür wurde in \textit{Home.vue} ein weiteres Attribut \textit{selectedTag} angelegt.
Jedem Tag-Element auf der Startseite wurde ein \textit{OnClick Listener}, welche bei einem Klick das jeweilige Element als \textit{selectedTag}.
\begin{lstlisting}
...
Auch wurde dies dafür genutzt, ein Setup-Guide\footnote{https://github.com/project-leek/project-leek/blob/docs/Build.md} zu schreiben, sodass andere Nutzer dieses Produkt Zuhause eirichten könnten.
