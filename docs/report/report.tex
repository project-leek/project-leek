...
So könnte der folgende und letzte Meilenstein für letzte Korrekturen am Bericht und das Vorbereiten der Projektpräsentation genutzt werden.
...
Auf allen Seiten wurde die Höhe des \textit{Header} und \textit{Footer} angepasst, das diese immer gleich ist.
Der \textit{Button Component} wurde überarbeitet, dass auch dieser universell für alle Anwendungszwecke benutzt werden kann
\colorbox{red}{@JULIAN HIER ZUM BUTTON AUSFÜHREN}
