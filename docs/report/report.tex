...
readme, how to contribute, list und order hardware, mono repo, Anforderungsanalyse, tech stack, backlog
...
Eine Hello World Aufgabe absolvieren, sich mit der Hardware, dem NFC Reader und Raspberry Pi, auseinandersetzen und erste Mockups für das User Interface sowie den begleitenden Bericht anfertigen.
\subsubsection{Ziel}
...
\subsubsection{Product Increment}
\colorbox{red}{TODO:}hello world, mockup, backend, feathers, nfc reader anschließen, shippable docker image, show data in ui, nfc reader package on pi, linter rules
...
\colorbox{red}{TODO:}seed nfc tags damit alle arbeitn können, prototyping flows und mockups, spotify abspielen,
\subsubsection{Ziel}
\colorbox{red}{TODO:}was haben wir uns vorgenommen, was war das ziel, was wollten wir schaffen?
\subsubsection{Probleme}
\colorbox{red}{TODO:}welche prrobleme sind aufgetreten?
...
\subsubsection{Product Increment}
\colorbox{red}{TODO:}oauth login spotify, abspielen, flows, frontend to github.io pages
...
\colorbox{red}{TODO:}implementation von musik auswählen, bild auswählen, tags anlegen, UI. mockup speaker sleection, first setup of box,
\subsubsection{Ziel}
\colorbox{red}{TODO:}was haben wir uns vorgenommen, was war das ziel, was wollten wir schaffen?
\subsubsection{Probleme}
\colorbox{red}{TODO:}welche prrobleme sind aufgetreten?
...
\subsubsection{Product Increment}
\colorbox{red}{TODO:}vite und typescript support in PR checks, UI elemente in vue komponenten gebaut, implementation von musik auswählen, bild auswählen, tags anlegen, tags suchen, designer design umsetzen,
...
\colorbox{red}{TODO:}setup guide, settings page, cleanup und bugfix dass zu 99 prozent fertig, small ui fixes
\subsubsection{Ziel}
\colorbox{red}{TODO:}was haben wir uns vorgenommen, was war das ziel, was wollten wir schaffen?
\subsubsection{Probleme}
\colorbox{red}{TODO:}welche prrobleme sind aufgetreten?
