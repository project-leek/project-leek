...
Das Team entschied sich zu Beginn der Produkt-Entwicklung dafür, Test zur Verbesserung der Codequalität zu nutzen.
Code Test lassen sich in zwei Arten unterteilen: statische und dynamische.

\subsection{Statische Tests}
Im Allgemeinen untersuchen statische Tests nur Textdokumente und betrachten nicht das Verhalten zur Laufzeit wie dynamische Tests.
Dies ermöglicht eine häufige und kontinuierliche Nutzung Tests dieser Art.
...
Für diese Werkzeug war zusätzlich auch eine Erweiterung für die Entwicklungsumgebung verfügbar.
...
Dies legte die Grundlage für lesbaren Code und ermöglichten successive effizientes Arbeiten.
...
Untersucht wurde vor allem semantische Fehler, Lesbarkeit, Wartbarkeit und Vollständigkeit.
Hierfür gab es keinen formalen Plan, allerdings war dei Review-Oberfläche von GitHub sehr hilfreich.
