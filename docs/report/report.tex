...
Dieses wurde vor allem aufgrund der zwei Hauptmerkmale \textit{components} und \textit{reactivity} entschieden.
...
Ausmaß, Funktionalität und Größe hiervon sind keine Einschränkungen gesetzt.
So kann es sich bei diesen Komponenten zum Beispiel um Buttons, Header oder auch ganze Webseiten handeln.
