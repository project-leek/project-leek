...
\colorbox{red}{ticket pool in github, alles zentral, 3x daily standup, gemeinsamer google calendar, interne team evaluation und feedback}
...
\colorbox{red}{Coden etc}

\subsubsection{Testphase}
\colorbox{red}{Tests halt, bau mal alles zusammen undso. Wurde am Ende aber auch mehr Hand in Hand mit der vorherigen gemacht}
