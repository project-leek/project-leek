...
\colorbox{red}{TODO: finde besseren Titel}\\
Insgesamt hat das Team durch das Projekt Informatik vieles gelernt in Bezug auf neue Technologien sowie Vor- und Nachteile von verschiedensten Codinggewohnheiten.

\subsection{Vorteil von Dev Ops}
Viele Teammitglieder kamen erst durch dieses Projekt das erste mal in den Kontakt mit Dev Ops.
In unserem Fall zeichnete sich durch verschiedene Merkmale aus.
...
\subsection{Regelmäßige Dailys und Retrospektiven}
...
Die häufigste Problem während des Projektes war es, kurz vor einem Milestone Meeting auch alle geplanten Tickets fehlerfrei umzusetzen und in den Master zu mergen.
...
So hat das Team auch sich vorgenommen, mindestens 2 Tage vor einem Milestone Meeting alle Tickets soweit fertig zu haben, dass diese nur noch sauber in den Master gemerged werden müssen.
