...
\section{Technische Umsetzung}
  ...
  \subsubsection{NFC Tags & NFC Reader}
    ...
    Die Steuerung der Box hat mittels NFC-Tags durchgeführt werden.
    NFC steht für \glqq Near Field Communication\grqq{} (Nahfeld-Kommunikation), ein Standart, der 
    ...
    variieren. In diesem Projekt wurden die primitivere NFC-Tags, welche nur eine ID speichern verwendet.
