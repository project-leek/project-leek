...
Auf allen Seiten wurde die Höhe des \textit{Header} und \textit{Footer} angepasst, sodass diese immer die gleiche Größte besitzen.
Der \textit{Button Component} wurde refactored, dass auch dieser universell für alle Anwendungszwecke benutzt werden kann.
Aus der Datenbank wurden die manuell generierten Einträge gelöscht.
Auf der Startseite wird nun dem User auch ein Hinweis angezeigt, falls dieser noch keine NFC-Tags angelegt hat.
...
%Product Increment
\colorbox{red}{Leekbox auswählbar, letzte bugfixes, @anton?}
