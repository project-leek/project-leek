...
\title{Projektbericht Leek-Box \\\large Smart Music Player \\ Projekt Informatik}
...
\includepdf[scale=0.75, pages=-, pagecommand=\subsection{Projektskizze}\label{pdf:macioprojektskizze}]
