...
\\
\\
Nach dem \textit{push} aller Änderungen, wird das Ergebnis der automatisierten Tests (\textit{GitHub Actions}) geprüft. Treten hierbei Fehler auf,
werden diese geprüfet und behoben. Sind alle Tests erfolgreich, betätigt der Entwickelnde die Schaltfläche \textit{Ready for Review}.
Wenn ein andere:r Entwickler:innen, diesen \textit{Pull-Request} sieht, wird ein \textit{Code-Review} durchgeführt.
