...
Nach erneuter Rücksprache mit dem Prüfenden ergab sich die Anforderung für den Bericht von 50-60 Seiten ohne Anhang.
...
Die Meilensteine wurden daher ausführlicher behandelt, es wurde mehr auf die Durchführengen und Herangehensweisen eingegangen.
Umgesetzter Quellcode wurde dort hinzugefügt, behandelt und erklärt.
Auch fehlten an vielen Stellen Bilder und Beispiele, die das jeweilige Problem besser veranschaulichen.
...
Am Ende dieser Präsentation sollte der Prüfende die Arbeitsleistung des Teams evaluieren können, der Kunde das Produkt selbstständig nutzen und weiterentwickeln können.
