...
\section{Technische Umsetzung}
  ...
  \subsubsection{NFC Tags & NFC Reader}
    ...
    So können NFC Tags genutzt werden, die eine \textit{Id} haben, um diese auf einen NFC Reader zu legen und somit ein \textit{Read-Event} auslösen.
    Dieser wird an den angeschlossenen Raspberry Pi weitergegeben und löst dann ein Event aus.
