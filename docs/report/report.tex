...
\\
\\
Am Anfag des Zyklus steht die Auswahl eines \textit{Issues} aus der Spalte \textit{ToDo} des \textit{Issue Boards}.
Nach Identifikation weist sich der Entwickler selbst dem Ticket zu. Daraufhin erstellt der verwendete Bot automatisch einen \textit{Branch}
